class SplashStore extends Citrus.Object
  constructor: () ->
    ...
    root.addEventListener "splash:found", (splash) =>
      this.addSplash(splash)
    ...
    if true
      ...
      @db.execute("CREATE TABLE splashes IF NOT EXISTS (id INTEGER PRIMARY KEY, 
        code STRING NOT NULL, name STRING NOT NULL, data TEXT NOT NULL)")
